...
class Lesson 
{
  constructor()
  {
    ...
    this.execute = (step) =>
    {
      ...
      resetScript += 'select *; label hide; draw * off; measure off; isosurface off; lcaoCartoon off; mo off; set spinX 0; set spinY 20; set spinZ 0;';
      resetScript += 'color ATOMS NONE; color BONDS NONE; color BALLS NONE;';
